                  ...
                  <div className="p-6 flex-grow flex flex-col">
                    <div className="flex justify-between items-start mb-6">
                      <div>
                        ...
                        <span className={`text-3xl font-black bg-clip-text text-transparent bg-gradient-to-br ${tier.color}`}>
                          {tier.price}
                        </span>
                      </div>
                    ...
                    <Button variant="outline" className="w-full group-hover:bg-white group-hover:text-black transition-all" onClick={openDonate}>
                      Select Tier
                    </Button>
                  </div>
                </GlassCard>
        ...
        <ScrollReveal>
          <div className="max-w-3xl mx-auto glass rounded-3xl p-8 md:p-12 text-center border border-white/10 relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <Button variant="primary" onClick={openDonate} className="px-12">Donate Now</Button>
            </div>
          </div>
        </ScrollReveal>
      </div>
