...
import { Briefcase, CheckCircle2, GraduationCap, Link as LinkIcon, Download } from "lucide-react";
            ...
            <div className="glass p-10 rounded-3xl border border-emerald-500/30 bg-emerald-500/5 text-center relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-luminous-muted mb-8 max-w-2xl mx-auto">
                  Applications will be accepted until December 31, 2025. Please submit your completed FLCRC employment application, cover letter, and resume to <a href="mailto:info@familylifecrc.org" className="text-emerald-400 hover:underline">info@familylifecrc.org</a>.
                </p>
                <div className="flex flex-col sm:flex-row justify-center gap-4">
                  <Button variant="outline" className="flex items-center gap-2" onClick={() => alert("This document is currently unavailable due to hosting issues. Please contact info@familylifecrc.org for a copy.")}>
