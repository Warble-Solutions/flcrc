  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Link href="/admin/programs/new" className="flex items-center gap-2 bg-[#6fa8dc] hover:bg-[#5b93c7] text-white font-bold text-sm px-4 py-2.5 rounded-xl transition-colors">
                  ...
                  <tr key={prog.id} className="hover:bg-white/5 transition-colors">
                    ...
                    <td className="px-6 py-4">
                      <button
                        ...
                        className={`cursor-pointer ${prog.is_featured ? "text-[#e6c830]" : "text-gray-600 hover:text-gray-400"}`}
                      >
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center justify-end gap-2">
                        <Link href={`/admin/programs/${prog.id}/edit`} className="p-2 text-gray-400 hover:text-[#6fa8dc] hover:bg-white/5 rounded-lg transition-all">
                          <Pencil size={16} />
                        </Link>
